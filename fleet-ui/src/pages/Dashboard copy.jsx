    ...
    <>
      ...
      <Row gutter={26}>
        <Col span={6} gutter={16}>
          <Card title="Vehicles" variant={false}>
            <Title level={2}>{counts.vehicles}</Title>
          </Card>
        </Col>

        <Col span={6} gutter={16}>
          <Card title="Drivers" variant={false}>
        ...
        <Col span={6} gutter={16}>
          <Card title="Employees" variant={false}>
            <Title level={2}>{counts.employees}</Title>
          </Card>
        </Col>

        <Col span={6} gutter={16}>
          <Card title="Complaints" variant={false}>
      ...
      <Row gutter={26} spacing="justify">
        ...
        <Col span={6} gutter={16}>
          <Card title="Job Cards" variant={false}>
            <Title level={2}>{counts.jobCards}</Title>
          </Card>
        </Col>

        <Col span={6} gutter={16}>
          <Card title="Inspections" variant={false}>
