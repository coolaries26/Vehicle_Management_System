...
spare_part_id INT REFERENCES transact.inventory(spare_part_id),
quantity INT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS transact.maintenance_parts_usage (
    ...
    job_card_id INT 
        REFERENCES transact.maintenance_job_card(job_card_id),
    spare_part_id INT 
        REFERENCES transact.inventory(spare_part_id),
    quantity INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS master.vendor(vendor_id serial primary key);
CREATE TABLE IF NOT EXISTS master.workshop(workshop_id serial primary key);
CREATE TABLE IF NOT EXISTS master.warehouse(warehouse_id serial primary key);
CREATE TABLE IF NOT EXISTS master.tool_kit(toolkit_id serial primary key);
CREATE TABLE IF NOT EXISTS master.vehicle_rc_document(rc_doc_id serial primary key);
CREATE TABLE IF NOT EXISTS master.driver_document(driver_doc_id serial primary key);
CREATE TABLE IF NOT EXISTS transact.vehicle_service_history(veh_svc_hist_id serial primary key);
CREATE TABLE IF NOT EXISTS transact.driver_vehicle_history(drvr_veh_hist_id serial primary key);
...
ON transact.maintenance_parts_usage(job_card_id);
